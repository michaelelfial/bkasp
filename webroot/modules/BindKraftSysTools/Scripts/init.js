...
(function (init) {
   ...
   init.AppMenu(appname,function(menu) {
       System.ShellShortcuts().regAppShortcut("SysTools", "SystemTools", "launchapp SysToolsApp");
        // Syntax 2
        
        menu.add({
            name:"Systen Tools",
            displayname: "systools",
            cmdline: "launchapp SysToolsApp",
            iconmodule: "BindKraftSysTools",
            icon: "listview.png",
            appclass: "SysToolsApp",
