...
<%
    ...
    %>
        <TR>
            <TD BGCOLOR="#E0E0F0" COLSPAN="<%= (ObjectsPerLine * 2) %>">
            <A HREF="<%= Self & "?" & ReqParam & "=0" %>"><IMG BORDER="0" SRC="minus.gif"></A>
            <%= TypeName %></TD>
        </TR>
        <TR>
    <%        
    ...
    %>
        <TR>
            <TD BGCOLOR="#E0E0F0" COLSPAN="<%= ObjectsPerLine * 2 - 1 %>"><A HREF="<%= Self & "?" & ReqParam & "=1" %>"><IMG BORDER="0" SRC="plus.gif"></A><%= TypeName %></TD>
        </TR>
    <%
        End If 
    End Sub
...
<%
    If F1 <> "" Then
        If F2 <> "" Then
            ...
            <INPUT TYPE="SUBMIT" VALUE="Create delete trigger">
            </FORM>
        <% Else
            %>1 Field selected: <%= F1 %><%
        End If        
