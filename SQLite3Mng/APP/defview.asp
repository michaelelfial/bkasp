...
<FORM METHOD="POST" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
    ...
    <% If Not bExecuted Then %>
        <% If r.Count > 0 Then %>
        <table border="0" width="100%" height="100%" bgcolor="#004080" cellspacing="1">
          <tr>
            <td width="100%" COLSPAN="2" NOWRAP ALIGN="CENTER"><B><FONT COLOR="#FFFFFF">View <%= r(1)("name") %></FONT></B></td>
          </tr>
          <tr>
            <td width="100%" height="100%" bgcolor="#FFFFFF" COLSPAN="2" align="center" NOWRAP>
              <textarea 
                NAME="QUERY" 
                rows="16" cols="100" 
                class="normalFont" style="height: 100%;width:100%; overflow:auto; border: 1px inset"><%= r(1)("sql") %></textarea><BR>
              </td>
          </tr>
          <tr>
        ...
        <table border="0" width="100%" height="100%" bgcolor="#004080" cellspacing="1">
          <tr>
            <td width="100%" COLSPAN="2" NOWRAP ALIGN="CENTER"><B><FONT COLOR="#FFFFFF">New view</FONT></B></td>
          </tr>
          <tr>
            <td width="100%" height="100%" bgcolor="#FFFFFF" COLSPAN="2" align="center" NOWRAP>
              <textarea 
                NAME="QUERY" 
                rows="16" cols="100" 
                class="normalFont" style="height: 100%; width:100%; overflow:auto; border: 1px inset"><%= query %></textarea><BR>
              </td>
          </tr>
          <tr>
             <td width="100%" COLSPAN="2" bgcolor="#FFFFFF" align="center" NOWRAP>
