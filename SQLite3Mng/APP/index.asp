...
<%
    ...
    Else
        bExecuted = False
        Set r = db.VExecute("SELECT * FROM sqlite_master WHERE name=$q;",1,0,Object)
    End If
    
    query = Request("QUERY")   
    
    If Request("QUERY").Count = 0 Then
        query = "CREATE INDEX <name> ON <table>(<column>,<column>,...);"
    End If
%>
<html>
...
<FORM METHOD="POST" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
    <% If Not bExecuted Then %>
        ...
        <table border="0" width="100%" bgcolor="#004080" cellspacing="1">
          <tr>
            <td width="100%" COLSPAN="2" NOWRAP ALIGN="CENTER"><B><FONT COLOR="#FFFFFF">Index <%= r(1)("name") %></FONT></B></td>
          </tr>
          <tr>
            <td width="100%" bgcolor="#FFFFFF" COLSPAN="2" align="center" NOWRAP>
              <textarea 
                NAME="QUERY" 
                rows="16" cols="100" 
                class="normalFont" style="border: 1px inset"><%= r(1)("sql") %></textarea><BR>
              </td>
          </tr>
          <tr>
        ...
        <table border="0" width="100%" bgcolor="#004080" cellspacing="1">
          <tr>
            <td width="100%" COLSPAN="2" NOWRAP ALIGN="CENTER"><B><FONT COLOR="#FFFFFF">New index</FONT></B></td>
          </tr>
          <tr>
            <td width="100%" bgcolor="#FFFFFF" COLSPAN="2" align="center" NOWRAP>
              <textarea 
                NAME="QUERY" 
                rows="16" cols="100" 
                class="normalFont" style="border: 1px inset"><%= query %></textarea><BR>
              </td>
          </tr>
          <tr>
             <td width="100%" COLSPAN="2" bgcolor="#FFFFFF" align="center" NOWRAP>
